          ...
          <el-form :inline="true">
            ...
            <el-form-item style="float: left">
              <el-input
                ...
                size="small"
                placeholder="请输入礼品名称"
                v-model="searchData.presentName"
              ></el-input>
            </el-form-item>
            ...
            <el-form-item style="float: left">
              <el-select size="small" v-model="searchData.presentType" clearable>
                <el-option
          ...
          >
            ...
            <el-table-column label="礼品名称" align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.presentName }}</span>
              </template>
            </el-table-column>
            <el-table-column label="礼品类型" align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.presentType }}</span>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    hanldeAdd() {
      // 添加
      this.$router.push("/server/present/add");
    },
    handleEdit(index, id) {
      this.$router.push("/server/present/" + id);
    },
