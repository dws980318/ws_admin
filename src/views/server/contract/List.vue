        ...
        <div style="width: 100%;height: auto">
          <el-form :inline="true">
            ...
            <el-form-item style="float: left">
              <el-input type="text" size="small" placeholder="请输入协议名称" v-model="searchData.title"></el-input>
            </el-form-item>
            <el-form-item style="float: left;" label>
              <el-date-picker
                ...
                range-separator="至"
                start-placeholder="协议签署时间"
                end-placeholder="协议到期时间"
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column label="协议类型" align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.agreementType }}</span>
              </template>
            </el-table-column>
            <el-table-column label="发布部门" align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.userDept }}</span>
              </template>
            </el-table-column>
            <el-table-column label="重要程度" align="center">
              <template slot-scope="scope">
                <span>{{ state_list[scope.row.importanceType] }}</span>
              </template>
            </el-table-column>
            ...
            <el-table-column label="协议签署时间" align="center" width="140">
              <template slot-scope="scope">
                <span>{{scope.row.startDate}}</span>
              </template>
            </el-table-column>
            <el-table-column label="协议到期时间" align="center" width="140">
              <template slot-scope="scope">
            ...
            <el-table-column label="状态" width="100" align="center">
              <template slot-scope="scope">
                ...
                >{{ state_list1[scope.row.status] }}</span>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    hanldeAdd() {
      // 添加
      this.$router.push("/server/contract/add");
    },
    handleEdit(index, id) {
      this.$router.push("/server/contract/" + id);
    },
