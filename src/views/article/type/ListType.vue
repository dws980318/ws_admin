    ...
    <el-row>
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <el-page-header @back="goBack" content="字典类型"></el-page-header>
          <!-- <p style="font-size:20px;line-height: 40px;color:#445566;">字典类型</p> -->
          <el-form :inline="true">
...
export default {
  ...
  methods: {
    ...
    init() {
      this.loading = true;
      this.$api.dic
        .listType(this.URLparams, this.searchData)
        .then((res) => {
    ...
    hanldeAdd() {
      // 添加
      this.$router.push("/article/type/listType/add");
    },
    handleEdit(index, id) {
      this.$router.push("/article/type/listType/" + id);
    },
