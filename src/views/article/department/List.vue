    ...
    <el-row>
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <p style="font-size:20px;line-height: 40px;color:#445566;">部门管理</p>
          <el-form :inline="true">
            ...
            <!-- <el-form-item style="float: left">
              <el-input type="text" size="small" placeholder="请输入部门名称" v-model="searchData.name"></el-input>
            </el-form-item>
            <el-form-item style="float: left" label-width="50">
...
export default {
  ...
  methods: {
    ...
    hanldeAdd() {
      // 添加
      this.$router.push("/article/department/add");
    },
    handleEdit(index, id) {
      this.$router.push("/article/department/" + id);
    },
