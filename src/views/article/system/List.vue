    ...
    <el-row>
      <el-col :span="24">
        <div style="width: 100%;height: auto">
          <p style="font-size:20px;line-height: 40px;color:#445566;">访问日志</p>
          <el-form :inline="true">
            ...
            <el-form-item label>
              <el-input size="small" v-model="searchData.logName" placeholder="请输入日志名称"></el-input>
            </el-form-item>
            <el-form-item label>
              <el-input size="small" v-model="searchData.userName" placeholder="请输入操作人"></el-input>
            </el-form-item>
            <el-form-item label>
              <el-input size="small" v-model="searchData.ip" placeholder="请输入ip"></el-input>
            </el-form-item>
            <el-form-item label>
              <el-date-picker
                size="small"
        ...
        <div class="table">
          ...
          >
            ...
            <el-table-column prop="className" label="日志类型" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop="ip" label="访问IP" :show-overflow-tooltip="true"></el-table-column>
          ...
          <el-pagination
            ...
            :current-page="URLparams.pageNumber"
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, id) {
      ...
      // }
      this.$router.push("/article/system/" + id);
    },
    handleSuccess(data) {
      console.log(data);
      this.visible = false;
