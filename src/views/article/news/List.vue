<template>
  <div>
    <el-row>
      <el-col :span="24">
        <p style="font-size:20px;line-height: 40px;color:#445566;">角色管理</p>
        <div style="width: 100%;height: auto">
          <el-form :inline="true">
            ...
            <el-form-item style="float: left" label-width="50">
              ...
              <!-- <el-button type="success" size="small" @click="hanldePutaway">启用</el-button>
              <el-button type="success" size="small" @click="hanldeSoldout">禁用</el-button>-->
              <el-button
                type="danger"
                size="small"
                icon="el-icon-delete"
              ...
              >批量删除</el-button>
              <el-button size="small" type="success" @click="handleMenu">菜单权限</el-button>
            </el-form-item>
          </el-form>
        </div>
        <div class="table">
          ...
          >
            ...
            <el-table-column label="角色描述" align="center" width="100">
              <template slot-scope="scope">
                <span
                  @click="showModal(scope.row.remark)"
                  class="warning-state"
  ...
  methods: {
    ...
    handleMenu() {
      if (this.selection.length === 0) {
        this.$message.error("请选择一条数据编辑权限！");
      } else if (this.selection.length > 1) {
        this.$message.error("只能选择一条数据编辑权限！");
      } else {
        this.$router.push("/article/news/menu/" + this.selection[0].id);
      }
    },
