    ...
    <div class="table">
      ...
      <el-row>
        <el-col :span="12" class="flex">
          ...
          <el-select v-model="form.name4" style="flex:1;" placeholder="请选择礼品名称">
            <el-option
      ...
      <el-row class="flex">
        ...
        <el-input type="textarea" v-model="form.name" style="flex:1;height: 80px;border-left: 1px solid #000;"></el-input>
      </el-row>
      <el-row>
        <el-col :span="12" class="flex">
